	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': {
						boxShadow: '0 0 20px rgba(251, 146, 60, 0.5), 0 0 40px rgba(236, 72, 153, 0.4), 0 0 60px rgba(251, 113, 133, 0.3)'
					},
					'50%': {
						boxShadow: '0 0 30px rgba(251, 146, 60, 0.7), 0 0 60px rgba(236, 72, 153, 0.6), 0 0 90px rgba(251, 113, 133, 0.5)'
					}
				}
			},
			animation: {

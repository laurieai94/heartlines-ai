...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rich-black via-graphite to-dark-gray relative overflow-hidden">
      {/* Elegant Monochrome Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-graphite/60 via-dark-gray/40 to-rich-black/80 animate-gradient"></div>
      <div className="absolute inset-0 bg-gradient-to-tr from-medium-gray/10 via-soft-gray/5 to-graphite/15 animate-gradient" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-warm-white/20 rounded-full animate-monochrome-pulse"
            style={{
      ...
      {/* Floating Geometric Shapes - Elegant */}
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="absolute w-20 h-20 border border-warm-white/10 rounded-lg animate-spin"
            style={{
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
      ...
      <div className="absolute inset-0 overflow-hidden opacity-5">
        ...
        <div className="absolute top-1/3 right-20 font-mono text-xs text-soft-gray">
      ...
      <nav className="px-6 py-4 relative z-10 bg-gradient-to-r from-rich-black/40 via-graphite/20 to-rich-black/40 backdrop-blur-sm border-b border-warm-white/10">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-gradient-to-r from-graphite to-dark-gray rounded-xl flex items-center justify-center shadow-elegant backdrop-blur-sm border border-warm-white/20">
          ...
          <div className="flex items-center">
            <Link to="/dashboard">
              <Button variant="outline" className="border-warm-white/50 text-warm-white hover:bg-warm-white/10 rounded-full font-thin backdrop-blur-sm">
      ...
      {/* Hero Section - Sophisticated Monochrome */}
      <section className="relative px-6 py-20 lg:py-28 bg-gradient-to-br from-rich-black/60 via-graphite/40 to-dark-gray/60 backdrop-blur-sm">
        ...
        <div className="absolute top-20 left-20 w-32 h-32 bg-gradient-to-r from-warm-white/5 to-soft-gray/10 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-24 h-24 bg-gradient-to-r from-medium-gray/8 to-warm-white/5 rounded-full blur-xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        
        <div className="absolute inset-0 bg-gradient-to-r from-graphite/5 via-dark-gray/10 to-graphite/5"></div>
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative z-10">
              <div 
                className="inline-flex items-center gap-3 bg-warm-white/5 backdrop-blur-lg rounded-full px-6 py-3 mb-8 border border-warm-white/20 shadow-elegant transition-transform duration-300"
                style={{
                  transform: `translate(${mousePosition.x * 0.01}px, ${mousePosition.y * 0.01}px)`
                }}
              >
                <div className="w-2 h-2 bg-gradient-to-r from-warm-white to-soft-gray rounded-full animate-pulse"></div>
              ...
              <h1 className="text-5xl lg:text-7xl font-thin text-warm-white mb-8 leading-tight">
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-soft-gray to-warm-white">
              ...
              <Link to="/dashboard">
                <Button className="bg-gradient-to-r from-rich-black to-graphite hover:from-graphite hover:to-dark-gray text-warm-white px-10 py-7 text-lg rounded-full shadow-elegant hover:shadow-3xl transition-all duration-500 transform hover:scale-105 border border-warm-white/20 font-light backdrop-blur-sm">
                  Get Started - It's Free
            ...
            {/* Phone with Dating App - Elegant Monochrome */}
            <div className="relative flex items-center justify-center">
              <div className="relative">
                {/* Phone Frame */}
                <div className="relative w-80 h-[600px] bg-rich-black rounded-[2.5rem] p-3 shadow-3xl border border-warm-white/20">
                  {/* Phone Screen */}
                  <div className="w-full h-full bg-gradient-to-b from-graphite to-rich-black rounded-[2rem] overflow-hidden relative">
                    ...
                    <div className="px-6 pb-4">
                      <div className="flex items-center justify-between">
                        <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-warm-white to-soft-gray">RealSwipe</h2>
                        <div className="w-8 h-8 bg-gradient-to-r from-graphite to-dark-gray rounded-full flex items-center justify-center">
                      ...
                      {datingProfiles.map((_, index) => (
                        <div
                          ...
                          className={`w-2 h-2 rounded-full transition-all duration-300 ${
                            index === currentProfile ? 'bg-warm-white' : 'bg-warm-white/30'
                          }`}
                        />
                      ))}
                    </div>
                ...
                {/* Floating Elements */}
                <div className="absolute -top-8 -right-8 w-16 h-16 bg-warm-white/10 backdrop-blur-sm rounded-full flex items-center justify-center border border-warm-white/20 animate-pulse">
                  <Heart className="w-6 h-6 text-warm-white" />
                </div>
      ...
      {/* Visual Break with Accent - Monochrome */}
      <section className="px-6 py-8 relative bg-gradient-to-r from-graphite/40 via-dark-gray/20 to-graphite/40 backdrop-blur-sm border-y border-warm-white/10">
        <div className="max-w-6xl mx-auto">
          <div className="relative flex items-center justify-center">
            {/* Gradient line with floating dots */}
            <div className="w-full h-px bg-gradient-to-r from-transparent via-warm-white/40 to-transparent"></div>
            {/* Accent dots */}
            <div className="absolute left-1/4 w-2 h-2 bg-warm-white/60 rounded-full animate-pulse"></div>
            <div className="absolute right-1/4 w-2 h-2 bg-soft-gray/60 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
            {/* Center icon */}
            <div className="absolute bg-gradient-to-r from-rich-black/50 to-graphite/50 px-6 backdrop-blur-sm rounded-full">
              <div className="w-12 h-12 bg-gradient-to-r from-graphite to-dark-gray rounded-full flex items-center justify-center mb-4 mx-auto border border-warm-white/20">
                <Heart className="w-6 h-6 text-warm-white" />
              </div>
            </div>
          </div>
      ...
      {/* Real Talk Section - Enhanced Monochrome */}
      <section className="px-6 py-20 relative bg-gradient-to-br from-graphite/40 via-dark-gray/30 to-graphite/40 backdrop-blur-sm border-y border-warm-white/10">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-rich-black/8 via-graphite/12 to-rich-black/8"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(255,255,255,0.05),transparent_50%),radial-gradient(circle_at_70%_80%,rgba(255,255,255,0.08),transparent_50%)]"></div>
        
        {/* Accent Lines */}
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-warm-white/40 to-transparent"></div>
        <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-soft-gray/40 to-transparent"></div>
        
        {/* Side Accent Elements */}
        <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-1 h-32 bg-gradient-to-b from-warm-white/30 to-medium-gray/30"></div>
        <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-1 h-32 bg-gradient-to-b from-medium-gray/30 to-warm-white/30"></div>
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl lg:text-6xl font-thin text-warm-white mb-8 leading-tight">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-soft-gray to-warm-white mt-3 text-4xl lg:text-5xl">
                Now what?
              </span>
            </h2>
          ...
          <div className="relative flex items-center justify-center mb-16">
            <div className="w-full h-px bg-gradient-to-r from-transparent via-warm-white/30 to-transparent"></div>
            <div className="absolute bg-gradient-to-r from-graphite to-dark-gray rounded-full p-4 shadow-elegant border border-warm-white/20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-8 flex items-center">
              <div className="bg-gradient-to-br from-graphite/30 via-dark-gray/20 to-graphite/30 backdrop-blur-xl rounded-3xl p-12 border border-warm-white/20 shadow-elegant flex items-center justify-center min-h-[300px]">
                <h3 className="text-4xl lg:text-5xl font-light text-transparent bg-clip-text bg-gradient-to-r from-warm-white to-soft-gray text-center leading-tight">
                  Enter RealTalk.
                </h3>
              </div>
            </div>
      ...
      {/* How It Actually Works - Monochrome */}
      <section className="px-6 py-20 relative bg-gradient-to-br from-rich-black/60 via-graphite/40 to-rich-black/60 backdrop-blur-sm border-b border-warm-white/5">
        ...
        <div className="absolute inset-0 overflow-hidden opacity-20">
          <div className="absolute top-1/3 left-0 w-full h-px bg-gradient-to-r from-transparent via-warm-white/20 to-transparent"></div>
          <div className="absolute top-2/3 left-0 w-full h-px bg-gradient-to-r from-transparent via-soft-gray/20 to-transparent"></div>
        </div>
        
        <div className="absolute inset-0 bg-gradient-to-r from-graphite/5 via-dark-gray/10 to-graphite/5"></div>
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <div className="w-16 h-16 bg-gradient-to-r from-graphite to-dark-gray rounded-full flex items-center justify-center mb-6 mx-auto border border-warm-white/20">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8 border-0 shadow-elegant bg-warm-white/5 backdrop-blur-lg hover:shadow-3xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 rounded-3xl group border border-warm-white/15">
              <div className="w-20 h-20 bg-gradient-to-br from-graphite/40 to-dark-gray/40 rounded-full flex items-center justify-center mb-6 shadow-elegant group-hover:scale-110 transition-transform backdrop-blur-sm border border-warm-white/20">
                <Brain className="w-10 h-10 text-warm-white" />
              </div>
            ...
            <Card className="p-8 border-0 shadow-elegant bg-warm-white/5 backdrop-blur-lg hover:shadow-3xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 rounded-3xl group border border-warm-white/15">
              <div className="w-20 h-20 bg-gradient-to-br from-dark-gray/40 to-graphite/40 rounded-full flex items-center justify-center mb-6 shadow-elegant group-hover:scale-110 transition-transform backdrop-blur-sm border border-warm-white/20">
                <Target className="w-10 h-10 text-warm-white" />
              </div>
            ...
            <Card className="p-8 border-0 shadow-elegant bg-warm-white/5 backdrop-blur-lg hover:shadow-3xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 rounded-3xl group border border-warm-white/15">
              <div className="w-20 h-20 bg-gradient-to-br from-dark-gray/40 to-graphite/40 rounded-full flex items-center justify-center mb-6 shadow-elegant group-hover:scale-110 transition-transform backdrop-blur-sm border border-warm-white/20">
                <MessageCircle className="w-10 h-10 text-warm-white" />
              </div>
      ...
      {/* Why Different Section - Monochrome */}
      <section className="px-6 py-20 relative bg-gradient-to-br from-graphite/60 via-dark-gray/40 to-graphite/60 backdrop-blur-sm border-b border-warm-white/5">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-rich-black/5 via-graphite/10 to-rich-black/5"></div>
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <div className="w-16 h-16 bg-gradient-to-r from-graphite to-dark-gray rounded-full flex items-center justify-center mb-6 mx-auto border border-warm-white/20">
              <Sparkles className="w-8 h-8 text-warm-white" />
            ...
            <h3 className="text-2xl font-light text-transparent bg-clip-text bg-gradient-to-r from-warm-white to-soft-gray mb-12">
      ...
      {/* Final CTA Section - Elegant Monochrome */}
      <section className="px-6 py-20 relative bg-gradient-to-br from-dark-gray/40 via-graphite/40 to-dark-gray/40 backdrop-blur-sm">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-10">
          <div className="w-96 h-96 border border-warm-white/20 rounded-full animate-pulse"></div>
          <div className="absolute w-80 h-80 border border-soft-gray/15 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
          <div className="absolute w-64 h-64 border border-warm-white/10 rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
        
        <div className="absolute inset-0 bg-gradient-to-r from-graphite/5 via-rich-black/5 to-graphite/5"></div>
        <div className="max-w-5xl mx-auto text-center relative z-10">
          {/* Header with Icon */}
          <div className="mb-12">
            <div className="w-20 h-20 bg-gradient-to-r from-graphite to-dark-gray rounded-full flex items-center justify-center mb-8 mx-auto border border-warm-white/20 shadow-elegant">
            ...
            <h2 className="text-4xl lg:text-5xl font-thin text-warm-white mb-8 leading-tight">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-warm-white to-soft-gray"> Get Better at Love</span>
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <Card className="p-8 border-0 shadow-elegant bg-warm-white/5 backdrop-blur-lg rounded-3xl border border-warm-white/15 hover:shadow-3xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-3">
              <div className="w-16 h-16 bg-gradient-to-r from-graphite/40 to-dark-gray/40 rounded-full flex items-center justify-center mb-6 mx-auto border border-warm-white/20">
                <MessageSquare className="w-8 h-8 text-warm-white" />
              </div>
            ...
            <Card className="p-8 border-0 shadow-elegant bg-warm-white/5 backdrop-blur-lg rounded-3xl border border-warm-white/15 hover:shadow-3xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-3">
              <div className="w-16 h-16 bg-gradient-to-r from-dark-gray/40 to-graphite/40 rounded-full flex items-center justify-center mb-6 mx-auto border border-warm-white/20">
          ...
          <div className="mb-12">
            ...
            <Link to="/dashboard">
              <Button className="bg-gradient-to-r from-rich-black to-graphite hover:from-graphite hover:to-dark-gray text-warm-white px-12 py-8 text-xl rounded-full shadow-elegant hover:shadow-3xl transition-all duration-500 transform hover:scale-105 border border-warm-white/20 mb-6 font-light">
                Create Your Profile
                <ArrowRight className="w-6 h-6 ml-3" />
              </Button>
            </Link>
          ...
          <div className="bg-gradient-to-r from-graphite/20 to-dark-gray/20 backdrop-blur-lg p-8 rounded-3xl border border-warm-white/15">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-8 h-8 bg-gradient-to-r from-graphite/50 to-dark-gray/50 rounded-full flex items-center justify-center border border-warm-white/20">
                <Heart className="w-4 h-4 text-warm-white" />
              </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                <div className="w-12 h-12 bg-warm-white/10 rounded-full flex items-center justify-center mb-3 mx-auto border border-warm-white/20">
                  <Sparkles className="w-5 h-5 text-warm-white" />
                </div>
      ...
      {showFloatingButton && (
        <div className="fixed bottom-8 right-8 z-50 animate-fade-in">
          <Link to="/dashboard">
            <Button className="bg-gradient-to-r from-rich-black to-graphite hover:from-graphite hover:to-dark-gray text-warm-white px-6 py-4 rounded-full shadow-elegant hover:shadow-3xl transition-all duration-500 transform hover:scale-105 backdrop-blur-sm border border-warm-white/20">
              Try It Now
      ...
      <footer className="px-6 py-16 bg-rich-black/70 backdrop-blur-sm relative border-t border-warm-white/10">
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="w-8 h-8 bg-gradient-to-r from-graphite to-dark-gray rounded-full flex items-center justify-center shadow-elegant backdrop-blur-sm border border-warm-white/20">
              <Heart className="w-5 h-5 text-warm-white" />
            </div>

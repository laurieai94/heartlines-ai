...
const Auth = () => {
  ...
  return <div className="min-h-screen questionnaire-bg auth-page-scroll">
      ...
      <div className="relative z-10 min-h-screen">
        ...
        {isSignUp && <div className="absolute top-64 sm:top-56 left-1/2 transform -translate-x-1/2 z-20 w-full max-w-sm px-4">
        ...
        <div className={`flex items-start sm:items-center justify-center min-h-screen px-4 ${isSignUp ? 'pt-96 sm:pt-80 pb-8' : 'pt-12 pb-8'}`}>

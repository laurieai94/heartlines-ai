...
const Auth = () => {
  ...
  return <div className="min-h-screen questionnaire-bg auth-page-scroll">
      ...
      <div className="relative z-10 min-h-screen">
        ...
        {isSignUp && <div className="absolute top-48 left-1/2 transform -translate-x-1/2 z-20 w-full max-w-sm px-4">
        ...
        <div className={`flex items-center justify-center min-h-screen px-4 ${isSignUp ? 'pt-64 sm:pt-80 pb-8' : 'pt-2 sm:pt-8 pb-8'}`}>

  ...
  return (
    <NavigationProvider goToProfile={handleGoToProfile} goToCoach={handleGoToCoach}>
      <div className={`h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 ${shouldShowSignUpModal ? 'blur-sm' : ''} transition-all duration-300 flex flex-col overflow-hidden`}>
        ...
        <div className="flex-shrink-0 w-full bg-white/80 backdrop-blur-sm border-b border-gray-100/50 shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* Compact Header */}
            <div className="flex items-center justify-between py-3">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center shadow-md">
                  <Heart className="w-4 h-4 text-white" />
                </div>
                <div>
                  <h1 className="text-xl font-bold text-gray-900">RealTalk</h1>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <div className="flex justify-center pb-3">
                <div className="w-full max-w-2xl">
                  <TabsList className="grid grid-cols-4 w-full h-10 bg-white/90 backdrop-blur-sm shadow-sm border border-gray-100/50 rounded-xl p-1 gap-1">
                    <TabsTrigger 
                      value="profile" 
                      className="flex items-center justify-center gap-2 rounded-lg py-2 px-3 text-sm font-medium transition-all duration-200 data-[state=active]:bg-gray-50 data-[state=active]:text-gray-900 data-[state=active]:shadow-sm text-gray-600 hover:text-gray-800 hover:bg-gray-50/50"
                    >
        ...
        {/* Main Content - Fills remaining screen, no overflow */}

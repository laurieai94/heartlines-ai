  ...
  return (
    <NavigationProvider goToProfile={handleGoToProfile} goToCoach={handleGoToCoach}>
      <div className="h-screen overflow-hidden">
        ...
        <div className={`h-full flex flex-col bg-gradient-to-br from-violet-900/80 via-purple-800/60 to-orange-900/40 ${isAnyModalOpen ? 'blur-sm' : ''} transition-all duration-300`}>
          <DashboardHeader 

  ...
  static buildPersonContext(profiles: ProfileData, demographicsData: DemographicsData): PersonContext {
    ...
    const context = {
      ...
      yourTraits: {
        ...
        loveLanguages: this.normalizeToArray(yourData.loveLanguages || yourData.feelLovedWhen),
        ...
        stressResponse: this.normalizeToArray(yourData.stressResponse || yourData.stressReactions),
        attachmentStyle: yourData.attachmentStyle || yourData.attachmentStyles,
        triggers: this.normalizeToArray(yourData.triggers),
        strengths: this.normalizeToArray(yourData.strengths || yourData.workingWell || yourData.relationshipPositives),
        growthAreas: this.normalizeToArray(yourData.growthAreas || yourData.biggestChallenge || yourData.relationshipChallenges),
        familyDynamics: this.normalizeToArray(yourData.familyDynamics),
        familyBackground: yourData.familyBackground,
        whyRealTalk: this.normalizeToArray(yourData.whyRealTalk || yourData.motivations),
        ...
        parentConflictStyle: this.normalizeToArray(yourData.parentConflictStyle),
        loveMessages: this.normalizeToArray(yourData.loveMessages),
        loveInfluences: this.normalizeToArray(yourData.loveInfluences || yourData.relationshipInfluences),
        relationshipLength: yourData.relationshipLength,
        feelsDifficult: this.normalizeToArray(yourData.feelsDifficult),
        hopingFor: this.normalizeToArray(yourData.hopingFor),
        readiness: this.normalizeToArray(yourData.readiness),
        healthyRelationship: this.normalizeToArray(yourData.healthyRelationship),
        additionalInfo: yourData.additionalInfo,
        profileComplete: yourData.profileComplete,
        completedAt: yourData.completedAt,
        datingChallenges: this.normalizeToArray(yourData.datingChallenges),
        datingGoals: this.normalizeToArray(yourData.datingGoals),
        ...
        separationSituation: this.normalizeToArray(yourData.separationSituation),
        datingReadiness: this.normalizeToArray(yourData.datingReadiness),
        timeSinceLoss: yourData.timeSinceLoss,
        grievingProcess: this.normalizeToArray(yourData.grievingProcess),
        // Foundation fields
        heartbreakBetrayal: this.normalizeToArray(yourData.heartbreakBetrayal),
        familyStructure: this.normalizeToArray(yourData.familyStructure)
      },
      partnerTraits: {
        name: partnerData.name || yourData.partnerName,
        age: partnerData.age,
        pronouns: partnerData.pronouns || partnerData.customPronouns,
        loveLanguages: this.normalizeToArray(partnerData.loveLanguages || partnerData.feelLovedWhen),
        ...
        stressResponse: this.normalizeToArray(partnerData.stressResponse || partnerData.stressReactions),
        attachmentStyle: partnerData.attachmentStyle || partnerData.attachmentStyles,
        triggers: this.normalizeToArray(partnerData.triggers),
        strengths: this.normalizeToArray(partnerData.strengths || partnerData.workingWell || partnerData.relationshipPositives),
        growthAreas: this.normalizeToArray(partnerData.growthAreas || partnerData.biggestChallenge || partnerData.relationshipChallenges),
        familyDynamics: this.normalizeToArray(partnerData.familyDynamics),
        familyBackground: partnerData.familyBackground,
        whyRealTalk: this.normalizeToArray(partnerData.whyRealTalk || partnerData.motivations),
        ...
        // New partner fields
        communicationResponse: this.normalizeToArray(partnerData.communicationResponse),
        selfAwareness: partnerData.selfAwareness,
        heartbreakBetrayal: this.normalizeToArray(partnerData.heartbreakBetrayal),
        familyStructure: this.normalizeToArray(partnerData.familyStructure)
      },
      dynamics: {

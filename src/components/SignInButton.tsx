            ...
            <nav className="flex flex-col gap-0.5 pt-3 px-3 pb-3">
              {onOpenProfile && (
                <button
                  ...
                  className="flex items-center gap-4 px-3 py-3 rounded-xl cursor-pointer touch-manipulation transition-all duration-200 active:scale-98 text-white/90 bg-white/5 hover:bg-white/15 hover:text-white shadow-sm w-full text-left"
                  style={{ 
                    minHeight: '48px',

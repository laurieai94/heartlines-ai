    ...
    if (isMobile) {
      return (
        <Drawer open={showUserMenu} onOpenChange={setShowUserMenu} direction="right">
          ...
          <DrawerContent 
            className="w-[260px] h-full !bg-transparent bg-gradient-to-br from-burgundy-900/20 to-burgundy-800/30 backdrop-blur-xl border-l border-coral-400/20 p-0 fixed right-0 top-0 bottom-0"
          >

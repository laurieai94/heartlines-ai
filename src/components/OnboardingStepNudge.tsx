...
const OnboardingStepNudge = ({ completion, onStartProfile, className = "" }: OnboardingStepNudgeProps) => {
  ...
  return (
    <div className={`glass-burgundy rounded-xl border border-white/10 p-4 mb-6 ${className}`}>
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              {completion > 0 && (
                <span className="text-xs bg-white/10 text-white/90 px-2 py-0.5 rounded-full flex-shrink-0 border border-white/20">
                  {completion}% complete
                </span>
              )}
            </div>

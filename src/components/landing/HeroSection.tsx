      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative z-10">
            <div 
              className="inline-flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-full px-6 py-3 mb-8 electric-border transition-transform duration-300"
              style={{
                transform: `translate(${mousePosition.x * 0.005}px, ${mousePosition.y * 0.005}px)`
              }}
            >
              <div className="w-2 h-2 bg-electric-blue rounded-full animate-subtle-pulse"></div>
            ...
            <h1 className="text-5xl lg:text-7xl font-thin text-white mb-8 leading-tight">
              Stop getting relationship advice 
              <br />
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-12 leading-relaxed font-light">
              We're tired of relationship advice that sounds ancient. RealTalk gets it—modern love is messy, you're both slammed, and generic tips don't cut it.
            </p>
            
            <Link to="/dashboard">
              <Button className="bg-gradient-to-r from-electric-blue to-electric-purple hover:from-electric-blue/90 hover:to-electric-purple/90 text-white px-10 py-7 text-lg rounded-full shadow-elegant hover:shadow-3xl transition-all duration-300 transform hover:scale-105 electric-glow font-light">

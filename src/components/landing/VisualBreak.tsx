    ...
    <section className="px-6 py-8 relative bg-black border-y border-white/10">
      <div className="max-w-6xl mx-auto">
        <div className="relative flex items-center justify-center">
          ...
          {/* Center icon */}
          <div className="absolute bg-black px-6 rounded-full">
            <div className="w-12 h-12 bg-gradient-to-r from-electric-blue to-electric-purple rounded-full flex items-center justify-center mb-4 mx-auto border border-electric-blue/40">

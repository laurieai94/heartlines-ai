...
const QuestionCard = ({ 
  ...
  return (
    <div 
      className={`group bg-white/[0.08] backdrop-blur-xl rounded-2xl border border-white/12 px-6 py-4 space-y-3 transition-all duration-300 hover:bg-white/[0.12] hover:border-white/20 hover:shadow-lg hover:shadow-white/5 hover:-translate-y-0.5 relative overflow-hidden ${className}`}
      data-question-card
      id={questionId}
    >

...
export const loveLanguageOptions = [
  'Uninterrupted quality time (no phones)',
  'Physical touch and cuddles',
  'Being hyped up with words',
...
export const conflictStyleOptions = [
  ...
  'Need space to calm down first or I\'ll say something dumb',
  'Try to see where they\'re coming from',
  'Just want to fix it and move on',
  'Get emotional and need them to reassure me we\'re okay',

  ...
  return (
    <div className="space-y-4">
      ...
      <QuestionCard 
        ...
        showContinue={profileData.talkingDescription && profileData.talkingDescription.length > 0}
      ...
      >
        ...
        <div className="text-xs text-orange-400 mb-2">Select all that resonate</div>
        <div className="flex items-center gap-2 text-xs text-white/70 font-normal mb-3">
      ...
      <QuestionCard 
        ...
        showContinue={profileData.talkingChallenges && profileData.talkingChallenges.length > 0}

        ...
        <CarouselContent className="!ml-0">
          {shuffledSlides.map((slide, index) => (
            <CarouselItem key={index} className="!pl-0 basis-full">
              ...
              <h2 
                className="font-['Shrikhand'] text-6xl md:text-7xl lg:text-7xl xl:text-8xl 2xl:text-8xl bg-gradient-to-r from-coral-400 to-pink-500 bg-clip-text text-transparent leading-none drop-shadow-[0_4px_8px_rgba(0,0,0,0.3)]"
              >
                {slide.year}
              </h2>

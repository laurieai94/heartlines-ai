...
export const UpgradeModal = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent 
        className="w-[calc(100vw-2rem)] max-w-[calc(100vw-2rem)] sm:max-w-3xl lg:max-w-6xl max-h-[88vh] overflow-y-auto overflow-x-hidden bg-gradient-to-br from-burgundy-600/90 via-burgundy-700/85 to-burgundy-800/90 backdrop-blur-xl border-white/25 rounded-3xl p-4 sm:p-6 box-border"
      ...
      >
        ...
        <div className="mt-2 space-y-3">
          {/* Current Usage */}
          <Card className="backdrop-blur-xl rounded-2xl p-4 bg-gradient-to-br from-white/35 via-white/30 to-white/25 border border-white/50 shadow-xl w-full box-border">
          ...
          {/* Pricing Plans */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-2.5 md:gap-3 lg:gap-3.5 w-full mx-auto items-stretch overflow-x-hidden mt-5">
          ...
          <div className="text-center pt-0.5 pb-0 -mb-2">
            <Button
              variant="ghost"

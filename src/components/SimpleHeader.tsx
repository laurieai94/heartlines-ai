...
const SimpleHeader = ({ user, activeTab, onSignInClick, hideSignInButton = false }: SimpleHeaderProps) => {
  ...
  return (
    <div className="w-full fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-burgundy-900 via-burgundy-800 to-burgundy-900 mb-1 sm:mb-2" style={{ transform: 'none', isolation: 'isolate' }}>

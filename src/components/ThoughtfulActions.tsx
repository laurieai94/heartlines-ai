  ...
  return (
    <div className="w-full">
      <div className="space-y-10">
        ...
        <Card className="p-10 glass-slate border border-gold-400/25 shadow-gold rounded-2xl max-w-2xl mx-auto">
          <div className="text-center space-y-8">
            <div className="w-16 h-16 gold-sheen rounded-2xl flex items-center justify-center mx-auto shadow-gold">
            ...
            <Button
              ...
              className="gold-sheen hover:shadow-gold text-white px-8 py-3 text-base font-semibold shadow-gold hover:shadow-2xl transition-all duration-300 border-0 rounded-xl"
            >
              Plan Custom Action

    ...
    <div className="h-full overflow-y-auto">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="space-y-8">
          ...
          <Card className="p-8 bg-white/5 backdrop-blur-sm border border-white/10 shadow-xl rounded-2xl">
            <div className="text-center space-y-6">
              ...
              <Button
                ...
                className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white px-8 py-3 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 border-0 rounded-xl"
              >
                Plan Custom Action

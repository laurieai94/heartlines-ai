      ...
      <div className="space-y-10">
        ...
        <Card className="p-10 bg-white/10 backdrop-blur-sm border border-white/20 shadow-2xl rounded-2xl max-w-2xl mx-auto">
          <div className="text-center space-y-8">
            <div className="w-16 h-16 bg-gradient-to-r from-gold-400 via-tan-500 to-tan-600 rounded-2xl flex items-center justify-center mx-auto shadow-lg">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-gold-400 via-tan-500 to-tan-600 hover:from-gold-500 hover:via-tan-600 hover:to-tan-700 text-white px-8 py-3 text-base font-semibold shadow-2xl hover:shadow-3xl transition-all duration-300 border-0 rounded-xl"
            >
              Plan Custom Action

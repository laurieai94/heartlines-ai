    ...
    <div className="w-full">
      <div className="space-y-10">
        ...
        <div className="text-center space-y-6">
          ...
          <p className="text-lg text-gray-green-200/80 max-w-xl mx-auto leading-relaxed">
        ...
        <Card className="p-10 glass-botanical border border-orange-400/25 shadow-orange rounded-2xl max-w-2xl mx-auto">
          <div className="text-center space-y-8">
            <div className="w-16 h-16 orange-sheen rounded-2xl flex items-center justify-center mx-auto shadow-orange">
              <Lightbulb className="w-8 h-8 text-white" />
            </div>
            <div className="space-y-4">
              <h3 className="text-2xl font-bold text-white leading-tight">Create Your Own Action</h3>
              <p className="text-gray-green-200/80 max-w-md mx-auto leading-relaxed">
                Have a specific idea for connecting with {partnerName}? Let's plan it together and get personalized tips.
              </p>
            </div>
            <Button
              onClick={() => setShowCustomForm(true)}
              className="orange-sheen hover:shadow-orange text-white px-8 py-3 text-base font-semibold shadow-orange hover:shadow-2xl transition-all duration-300 border-0 rounded-xl"
            >
              Plan Custom Action

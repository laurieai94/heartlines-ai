...
const QuestionnaireModal = ({ isOpen, onClose }: QuestionnaireModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Container */}
      <div className="relative w-[85%] h-[90%] max-w-[1100px] max-h-[800px] bg-white/5 backdrop-blur-lg rounded-2xl shadow-[0_25px_50px_rgba(0,0,0,0.4)] border border-white/10 overflow-hidden animate-scale-in">
        {/* Close Button */}
        <Button
          variant="ghost"
          size="icon"

...
const QuestionnaireModal = ({ isOpen, onClose }: QuestionnaireModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-6 h-[95svh] bg-gradient-to-br from-purple-900/95 via-pink-900/95 to-blue-900/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
        {/* Close Button */}
        <button
          onClick={onClose}

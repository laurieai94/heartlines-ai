...
const AIChatInput = ({ 
  ...
  return (
    <div className={`flex gap-1.5 md:gap-3 items-center px-1.5 md:px-0 touch-action-manipulation pointer-events-auto cursor-text ${readOnly ? 'group' : ''}`} style={{ minHeight: (readOnly && window.innerWidth < 768) ? '52px' : '44px' }}>

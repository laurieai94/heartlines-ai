...
const ActionForm = ({ profiles, demographicsData, onClose, onSubmit }: ActionFormProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 glass flex items-center justify-center p-4 z-50">
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-off-white-200">
        <div className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Select value={category} onValueChange={setCategory}>
                  <SelectTrigger className="bg-white border-green-gray-400">
                    <SelectValue placeholder="What kind of gesture?" />
                  </SelectTrigger>
                  <SelectContent className="bg-white border-green-gray-400">
              ...
              <div>
                ...
                <Input
                  ...
                  className="bg-white border-green-gray-400"
                />
              </div>

...
export const ChatInputSection = ({
  ...
  return (
    <div 
      ref={containerRef}
      className="absolute bottom-0 left-0 right-0 md:relative flex-shrink-0 z-40 bg-burgundy-800/95 md:bg-burgundy-900/20 backdrop-blur-sm md:backdrop-blur-md"
      style={{
        paddingBottom: 'max(0.5rem, env(safe-area-inset-bottom))',
        backgroundColor: 'hsl(350, 100%, 20%, 0.95)'
      }}
    >

...
export const ChatInputSection = ({
  ...
  return (
    <div 
      ref={containerRef}
      className="chat-footer absolute bottom-0 left-0 right-0 flex-shrink-0 z-40 md:relative md:bottom-auto md:left-auto md:right-auto md:mb-6 lg:mb-8"
      style={{
    ...
    >
      <div>
        ...
        <div className="px-2 md:max-w-[54rem] md:mx-auto md:px-12">

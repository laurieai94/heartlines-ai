...
export const ChatHeader = ({
  ...
  return (
    <div className="md:sticky fixed top-[52px] md:top-0 left-0 right-0 z-[70] shrink-0 bg-burgundy-900 backdrop-blur-md border-b border-white/10 shadow-lg md:bg-burgundy-900/40 md:backdrop-blur-md">

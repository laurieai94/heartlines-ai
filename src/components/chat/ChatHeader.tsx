                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button 
                      ...
                      className="text-white/70 hover:text-white hover:bg-white/10 transition-colors min-h-[44px] min-w-[44px] md:min-h-[32px] md:min-w-[32px] rounded-xl md:flex md:flex-col md:items-center md:gap-1"
                    >
                      <Menu className="w-4 h-4 md:w-4 md:h-4" />

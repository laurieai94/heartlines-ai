...
export const ChatHeader = ({
  ...
  return (
    <div className="chat-header sticky top-0 z-40 md:z-[70] shrink-0 bg-burgundy-800 md:bg-burgundy-800/50 md:backdrop-blur-md border-b border-pink-400/10 shadow-lg">

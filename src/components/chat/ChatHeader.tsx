...
export const ChatHeader = ({
  ...
  return (
    <div className="chat-header sticky top-0 z-50 md:z-[70] shrink-0 bg-burgundy-800 md:bg-burgundy-800/50 backdrop-blur-none md:backdrop-blur-md border-b border-pink-400/10 shadow-lg">
      <div className="w-full px-2 md:px-0 py-3 md:py-4 lg:py-5 transition-transform duration-200 ease-out">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Popover>
                      ...
                      <PopoverContent 
                        ...
                        align="start" 
                        sideOffset={8}
                        className="w-[calc(100vw-32px)] max-w-md p-4 bg-white/10 backdrop-blur-xl border border-white/15 shadow-2xl ring-1 ring-white/10 rounded-2xl z-[100]"
                      >

...
export const ChatHeader = ({
  ...
  return (
    <div className="sticky top-0 z-40 shrink-0 bg-burgundy-950 border-b border-white/10 pt-[env(safe-area-inset-top)] md:bg-white/10 md:backdrop-blur-md">
      <div className="w-full px-1 py-2 md:max-w-5xl md:mx-auto md:px-3 md:py-2 lg:py-3 transition-transform duration-200 ease-out will-change-transform">
        ...
        {(!isMobile || isTablet) && (
          <div className="flex items-center justify-between gap-2 md:gap-3 md:max-w-3xl lg:max-w-4xl md:mx-auto md:px-3 lg:px-6 xl:pl-12 xl:pr-6">

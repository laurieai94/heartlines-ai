...
export const ChatHeader = ({
  ...
  return <div className="shrink-0 border-b border-white/10 bg-white/5 backdrop-blur-sm">
      <div className="p-2 px-2 sm:px-3 lg:px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {onOpenSidebar && <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="ghost" onClick={onOpenSidebar} className="text-white/70 hover:text-white hover:bg-white/10 transition-colors h-auto px-2 py-1.5 flex flex-col items-center gap-1">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="ghost" onClick={onNewConversation} className="text-white/70 hover:text-white hover:bg-white/10 transition-colors h-auto px-2 py-1.5 flex flex-col items-center gap-1">

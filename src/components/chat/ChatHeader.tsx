...
export const ChatHeader = ({
  ...
  return (
    <div className="sticky top-0 z-[70] shrink-0 bg-gradient-to-r from-burgundy-800/40 via-burgundy-800/40 to-burgundy-900/35 backdrop-blur-md border-b border-pink-400/10 shadow-lg translate-y-0">

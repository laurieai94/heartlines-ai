...
export const ChatLayout = ({ 
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-burgundy-900 md:bg-transparent px-0 md:px-4 lg:px-8 md:pt-0 lg:pt-0 md:pb-4 lg:pb-6">
      <div className="flex-1 flex">
        {/* Chat Section - Proportional Width */}
        <div className="flex-1 flex flex-col relative mx-auto w-full max-w-[1100px] xl:max-w-[1200px] 2xl:max-w-[1280px]">
          ...
          <div className="flex-1 flex flex-col bg-burgundy-900 md:bg-white/5 md:backdrop-blur-xl md:rounded-2xl lg:rounded-3xl md:border md:border-white/30 md:shadow-2xl md:shadow-black/30 md:ring-1 md:ring-white/10 md:ring-offset-1 md:ring-offset-burgundy-900/30 overflow-hidden relative z-10">

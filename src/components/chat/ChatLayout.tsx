    ...
    <div className="h-full md:h-[calc(100%-2rem)] lg:h-[calc(100%-2.5rem)] flex flex-col min-h-0 md:max-h-full px-0 lg:px-8 md:pt-4 lg:pt-6">
      <div className="flex-1 flex md:min-h-0 md:max-h-full">
        ...
        <div className="flex-1 flex flex-col relative mx-auto w-full max-w-[1100px] xl:max-w-[1200px] 2xl:max-w-[1280px] md:min-h-0 md:max-h-full">
          <div className="flex-1 flex flex-col min-h-0 bg-gradient-to-b from-burgundy-900/30 to-burgundy-800/20 backdrop-blur-xl md:rounded-2xl lg:rounded-3xl border border-white/20 md:border-white/30 shadow-2xl shadow-black/30 ring-1 ring-white/10 md:ring-offset-1 md:ring-offset-burgundy-800/30 relative z-10 isolation-isolate">

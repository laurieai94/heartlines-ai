...
export const ChatLayout = ({ 
  ...
  return (
    <div className="h-full flex flex-col bg-burgundy-900 md:bg-transparent px-0 md:pt-0 lg:pt-0 md:pb-4 lg:pb-6">
      <div className="flex-1 min-h-0 flex">
        {/* Chat Section - Proportional Width */}
        <div className="flex-1 min-h-0 max-h-full flex flex-col relative mx-auto w-full">

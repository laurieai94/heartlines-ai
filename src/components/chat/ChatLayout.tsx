    ...
    <div className="h-full flex flex-col max-h-full">
      <div className="flex-1 min-h-0 max-h-full flex">
        ...
        <div className="flex-1 min-h-0 max-h-full flex flex-col w-full">
          <div className="w-full flex-1 min-h-0 max-h-full flex flex-col bg-white/5 backdrop-blur-xl rounded-xl border border-white/10 shadow-2xl ring-1 ring-white/5 overflow-visible">

...
export const ChatLayout = ({ 
  ...
  return (
    <div className="h-full md:h-[calc(100%-2rem)] lg:h-[calc(100%-2.5rem)] flex flex-col min-h-0 md:max-h-full bg-burgundy-800 isolate md:bg-transparent md:isolation-auto px-0 lg:px-8 md:pt-4 lg:pt-6">

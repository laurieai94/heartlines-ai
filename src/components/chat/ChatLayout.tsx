...
export const ChatLayout = ({ 
  ...
  return (
    <div className="min-h-screen flex flex-col bg-burgundy-800 px-0 lg:px-8 pt-0 md:pt-4 lg:pt-6">
      <div className="flex-1 flex md:min-h-0 md:max-h-full">
        {/* Chat Section - Proportional Width */}
        <div className="flex-1 flex flex-col mx-auto w-full max-w-[1100px] xl:max-w-[1200px] 2xl:max-w-[1280px] px-2 md:px-0 md:min-h-0 md:max-h-full">

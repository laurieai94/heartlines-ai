  ...
  return <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[400px] max-w-[92vw] p-0 bg-transparent border-0 shadow-none mx-auto">
        <div className="relative min-h-[500px] flex items-center justify-center">
          {/* Burgundy animated background orbs */}
          <div className="absolute inset-0 overflow-hidden rounded-3xl">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-28 h-28 bg-gradient-to-br from-purple-400/20 to-coral-400/10 rounded-full blur-xl animate-float" style={{ animationDelay: '4s' }}></div>
          </div>
          
          {/* Glassmorphism card with burgundy tints */}
          <div className="relative glass rounded-3xl bg-gradient-to-br from-white/95 via-coral-50/80 to-peach-50/70 backdrop-blur-xl border border-white/30 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25),0_0_40px_rgba(134,25,87,0.15)] overflow-hidden">

...
const NavigationPullTab = ({ onOpenNavigation }: NavigationPullTabProps) => {
  ...
  return (
    ...
    >
      <FlipPhoneIcon className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-14 lg:w-14 xl:h-16 xl:w-16 2xl:h-18 2xl:w-18 text-primary-foreground drop-shadow-lg" />

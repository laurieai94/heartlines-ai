...
>(({ className, ...props }, ref) => (
  <AvatarPrimitive.Fallback
    ref={ref}
    className={cn(
      "flex h-full w-full items-center justify-center rounded-full bg-gradient-to-br from-coral-300 via-coral-400 to-coral-500 text-white font-bold shadow-inner",
      className
    )}
    {...props}
  />

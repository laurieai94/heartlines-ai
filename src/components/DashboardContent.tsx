...
const DashboardContent = ({
  ...
  const renderActiveTabContent = useMemo(() => {
    switch (activeTab) {
      ...
      case "profile":
        return (
          <div className="max-w-5xl mx-auto px-2 sm:px-6 lg:px-8 -mt-2 md:mt-0 overflow-y-auto h-full scrollbar-hide">
            <ProfileBuilder
  ...
  return (
    <div className={`flex-1 dashboard-container scrollbar-hide bg-burgundy-800 ${
      activeTab === 'coach' || activeTab === 'insights' 
        ? 'h-[100dvh] md:h-[calc(100vh-5rem)] md:overflow-hidden md:pt-20 lg:pt-24' 

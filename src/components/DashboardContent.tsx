...
const DashboardContent = ({
  ...
  const renderActiveTabContent = useMemo(() => {
    switch (activeTab) {
      ...
      case "coach":
        return (
          <div className="h-full flex flex-col mobile-coach-stretch pt-16 md:pt-[72px] lg:pt-20">
            <AIChat 
      ...
      case "profile":
        return (
          <div className="max-w-5xl mx-auto px-2 sm:px-6 lg:px-8 pt-10 md:pt-12 lg:pt-14 overflow-y-auto h-full scrollbar-hide">
            <ProfileBuilder

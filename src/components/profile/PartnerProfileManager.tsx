    ...
    <Card className="group questionnaire-card p-4 md:p-5 lg:p-6 hover:scale-[1.02] transition-transform duration-300">
      ...
      {limits.canAdd && (
        <Button
          ...
          disabled={isCreating}
          className="w-full mt-3 relative overflow-hidden bg-gradient-to-r from-orange-400 to-pink-500 hover:from-orange-500 hover:to-pink-600 text-white py-2 md:py-2.5 lg:py-3 rounded-xl font-semibold text-sm md:text-base lg:text-lg shadow-lg glass-cta-gradient min-h-[44px] md:min-h-[48px] lg:min-h-[52px]"
        >
      ...
      {!limits.canAdd && (
        <Button
          onClick={onUpgrade}
          variant="ghost"
          className="w-full mt-3 text-white/50 hover:text-white/70 hover:bg-white/5 text-sm font-medium"
        >

            ...
            <div className="px-4 sm:px-6 xl:px-8 py-6 sm:py-4 xl:py-6">
              ...
              <div className="max-w-6xl xl:max-w-7xl 2xl:max-w-8xl 3xl:max-w-8xl mx-auto relative z-10">
                <div className="grid md:grid-cols-2 gap-4 md:gap-8 lg:gap-12 xl:gap-16 items-center min-h-[50vh] md:min-h-[90vh]">
                  ...
                  <div className="text-left w-full self-center md:pt-0 px-4 sm:px-6 lg:px-8 xl:px-0 mt-8 md:mt-0 md:max-w-[95%] lg:max-w-[90%] xl:max-w-[90%] 2xl:max-w-[95%] md:pr-4 lg:pr-6 xl:pr-8">
                    <div className="space-y-2 mb-1 md:mb-6">
<h1 className="font-playfair font-normal leading-tight animate-fade-in text-transparent bg-clip-text bg-gradient-to-r from-coral-400 to-pink-400 drop-shadow-sm pr-12 pb-1 box-content" style={{

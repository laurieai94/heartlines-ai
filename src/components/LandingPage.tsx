          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
              ...
              <div className="relative flex items-center justify-center md:justify-end order-1">
                ...
                {/* CTA Button */}
                <div className="hidden md:block absolute right-0 translate-x-full pl-8 md:relative md:translate-x-0 md:mt-6 md:ml-0 md:right-auto animate-fade-in" style={{ animationDelay: '1s' }}>
                  <div className="relative group inline-block cursor-pointer" onClick={handleTalkToKai}>
                    {/* Glow effect */}

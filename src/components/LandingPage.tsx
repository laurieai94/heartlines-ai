                ...
                <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-12 2xl:gap-16 items-start min-h-full">
                  ...
                  <div className="text-left max-w-[580px] self-center">
                    <div className="space-y-3 mb-4 md:mb-6">
                      <h1 className="text-3xl sm:text-4xl lg:text-[50px] xl:text-[62px] 2xl:text-[74px] font-playfair font-normal leading-tight animate-fade-in">
                      ...
                      <h3 className="text-xl sm:text-2xl md:whitespace-nowrap lg:text-[32px] xl:text-[38px] 2xl:text-[50px] font-playfair font-normal leading-tight animate-fade-in text-white/90" style={{ animationDelay: '0.8s' }}>
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[calc(100vh-8rem)]">
                ...
                <div className="max-w-[580px]">
                  <div className="space-y-4 mb-6">
                    <h1 className="text-3xl lg:text-[38px] xl:text-[50px] font-playfair font-normal leading-tight animate-fade-in">
                      <span className="block text-transparent bg-clip-text bg-gradient-to-r from-coral-400 to-pink-400 drop-shadow-sm">
                        Modern love is messy.
                      </span>
                    </h1>
                    
                    <h3 className="text-lg md:whitespace-nowrap lg:text-[22px] xl:text-[26px] font-playfair font-normal leading-tight animate-fade-in text-white/90" style={{ animationDelay: '0.8s' }}>
                      <span className="font-brand">heartlines</span> helps you connect.
                    </h3>
                  </div>

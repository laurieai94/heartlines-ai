...
const LandingPage = ({
  ...
  return <div className="min-h-screen relative overflow-x-hidden overflow-y-auto landing-page-scroll bg-burgundy-900">
              ...
              <div className="max-w-6xl xl:max-w-7xl 2xl:max-w-8xl 3xl:max-w-8xl mx-auto relative z-10">
                <div className="grid md:grid-cols-2 gap-4 md:gap-12 xl:gap-16 2xl:gap-20 items-center min-h-[50vh] md:min-h-[90vh]">
                  ...
                  <div className="relative flex justify-center md:justify-end items-center self-center">
                    <div className="w-full max-w-md xl:max-w-lg 2xl:max-w-xl md:scale-100 xl:scale-120 2xl:scale-130 scale-100 sm:scale-105 md:scale-110 origin-center relative z-10">
      ...
      <section id="how-it-works" className="pt-0 pb-8 md:pt-0 md:pb-16 relative overflow-hidden bg-gradient-to-br from-burgundy-900 via-burgundy-800 to-burgundy-900">

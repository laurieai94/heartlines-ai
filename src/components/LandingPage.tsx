    ...
    <div className={`min-h-screen relative overflow-hidden ${
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-coral-300/30 rounded-full animate-pulse"
            style={{
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="absolute w-20 h-20 border border-coral-300/10 rounded-lg animate-spin"
            style={{
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
      ...
      <div className="absolute inset-0 overflow-hidden opacity-5">
        <div className="absolute top-20 left-10 font-mono text-xs text-coral-200">
        ...
        <div className="absolute bottom-1/3 left-1/4 font-mono text-xs text-coral-200">
      ...
      {/* Navigation */}
      {showMarketingTopBar && (
        <nav className="px-6 py-4 relative z-10 bg-gradient-to-r from-black/20 via-coral-900/10 to-black/20 backdrop-blur-sm border-b border-coral-300/10">
      ...
      {/* Hero Section */}
      <section className="relative px-6 py-20 lg:py-28 bg-gradient-to-br from-coral-950/30 via-black/20 to-coral-900/30 backdrop-blur-sm">
        {/* Accent decoration - floating orbs */}
        <div className="absolute top-20 left-20 w-32 h-32 bg-gradient-to-r from-coral-400/10 to-coral-400/10 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-24 h-24 bg-gradient-to-r from-coral-400/15 to-coral-400/15 rounded-full blur-xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        
        <div className="absolute inset-0 bg-gradient-to-r from-coral-500/5 via-white/5 to-coral-500/5"></div>
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative z-10">
              ...
              >
                <div className="w-2 h-2 bg-gradient-to-r from-coral-400 to-coral-400 rounded-full animate-pulse"></div>
              ...
              <h1 className="text-5xl lg:text-7xl font-thin text-white mb-8 leading-tight">
                ...
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-coral-400 to-coral-400">
              ...
              <Link to="/dashboard">
                <Button className="bg-gradient-to-r from-coral-400 to-coral-500 hover:from-coral-300 hover:to-coral-400 text-white px-10 py-7 text-lg rounded-full shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 border-0 font-light backdrop-blur-sm">
                  Get Started - It's Free
            ...
            <div className="relative flex items-center justify-center">
              <div className="relative">
                  ...
                  <div className="w-full h-full bg-gradient-to-b from-gray-900 to-black rounded-[2rem] overflow-hidden relative">
                    ...
                    <div className="px-6 pb-4">
                      <div className="flex items-center justify-between">
                        <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-coral-400 to-coral-400">RealSwipe</h2>
                        <div className="w-8 h-8 bg-gradient-to-r from-coral-400 to-coral-400 rounded-full flex items-center justify-center">
                    ...
                    <div className="px-6 pb-6 flex-1">
                      ...
                      >
                        {/* Profile Photo */}
                        <div className="w-full h-48 bg-gradient-to-br from-coral-400/20 to-coral-400/20 rounded-2xl overflow-hidden mb-4 border border-white/10">
                          <img 
                        ...
                        <div className="absolute bottom-6 left-6 right-6 flex justify-center gap-4">
                          ...
                          <div className="w-12 h-12 bg-coral-500/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-coral-400/30">
                      ...
                      {datingProfiles.map((_, index) => (
                        <div
                          ...
                          className={`w-2 h-2 rounded-full transition-all duration-300 ${
                            index === currentProfile ? 'bg-coral-400' : 'bg-white/30'
                          }`}
                        />
                      ))}
                    </div>
                ...
                {/* Floating Elements */}
                <div className="absolute -top-8 -right-8 w-16 h-16 bg-coral-400/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-coral-300/30 animate-pulse">
      ...
      <section className="px-6 py-8 relative bg-gradient-to-r from-coral-900/20 via-black/10 to-coral-900/20 backdrop-blur-sm border-y border-coral-400/10">
        <div className="max-w-6xl mx-auto">
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute right-1/4 w-2 h-2 bg-coral-400/60 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
            {/* Center icon */}
            <div className="absolute bg-gradient-to-r from-coral-900/50 to-coral-900/50 px-6 backdrop-blur-sm rounded-full">
              <div className="w-12 h-12 bg-gradient-to-r from-coral-400 to-coral-400 rounded-full flex items-center justify-center mb-4 mx-auto border border-coral-300/30">
      ...
      <section className="px-6 py-20 relative bg-gradient-to-br from-coral-900/20 via-black/15 to-coral-900/20 backdrop-blur-sm border-y border-coral-400/20">
        {/* Dramatic Background Effects */}
        <div className="absolute inset-0 bg-gradient-to-r from-coral-500/8 via-white/8 to-coral-500/8"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(255,114,94,0.15),transparent_50%),radial-gradient(circle_at_70%_80%,rgba(255,114,94,0.15),transparent_50%)]"></div>
        
        {/* Accent Lines */}
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-coral-400/60 to-transparent"></div>
        <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-coral-400/60 to-transparent"></div>
        
        {/* Side Accent Elements */}
        <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-1 h-32 bg-gradient-to-b from-coral-400/40 to-coral-400/40"></div>
        <div className="absolute right-0 top-1/2 transform -translate-y-1/2 w-1 h-32 bg-gradient-to-b from-coral-400/40 to-coral-400/40"></div>
        
        <div className="max-w-5xl mx-auto relative z-10">
          {/* Problem Setup Section */}
          <div className="text-center mb-16">
            <div className="inline-block bg-gradient-to-r from-coral-500/20 to-coral-500/20 backdrop-blur-lg rounded-full px-8 py-3 mb-8 border border-coral-300/30">
            ...
            <h2 className="text-5xl lg:text-6xl font-thin text-white mb-8 leading-tight">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-coral-400 to-coral-400 mt-3 text-4xl lg:text-5xl">
                Now what?
              </span>
            </h2>
          ...
          <div className="relative flex items-center justify-center mb-16">
            <div className="w-full h-px bg-gradient-to-r from-transparent via-coral-400/40 to-transparent"></div>
            <div className="absolute bg-gradient-to-r from-coral-400 to-coral-400 rounded-full p-4 shadow-2xl border border-coral-300/30">
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-8 flex items-center">
              <div className="bg-gradient-to-br from-coral-500/15 via-white/8 to-coral-500/15 backdrop-blur-xl rounded-3xl p-12 border border-coral-300/20 shadow-2xl flex items-center justify-center min-h-[300px]">
                <h3 className="text-4xl lg:text-5xl font-light text-transparent bg-clip-text bg-gradient-to-r from-coral-400 to-coral-400 text-center leading-tight">
                  Enter RealTalk.
                </h3>
              </div>
            </div>
            ...
            {/* Right Column */}
            <div className="space-y-8 flex items-center">
              <div className="bg-gradient-to-br from-coral-500/10 via-white/5 to-coral-500/10 backdrop-blur-xl rounded-3xl p-8 border border-coral-300/20 shadow-2xl">
      ...
      <section className="px-6 py-20 relative bg-gradient-to-br from-coral-900/30 via-black/20 to-coral-900/30 backdrop-blur-sm border-b border-coral-400/5">
        ...
        <div className="absolute inset-0 overflow-hidden opacity-20">
          ...
          <div className="absolute top-2/3 left-0 w-full h-px bg-gradient-to-r from-transparent via-coral-300/30 to-transparent"></div>
        </div>
        
        <div className="absolute inset-0 bg-gradient-to-r from-coral-500/5 via-white/8 to-coral-500/5"></div>
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <div className="w-16 h-16 bg-gradient-to-r from-coral-400 to-coral-400 rounded-full flex items-center justify-center mb-6 mx-auto border border-coral-300/30">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8 border-0 shadow-xl bg-coral-500/10 backdrop-blur-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 rounded-3xl group border border-coral-400/20">
              <div className="w-20 h-20 bg-gradient-to-br from-coral-400/20 to-coral-400/20 rounded-full flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform backdrop-blur-sm border border-coral-300/30">
            ...
            <Card className="p-8 border-0 shadow-xl bg-coral-500/10 backdrop-blur-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 rounded-3xl group border border-coral-400/20">
              <div className="w-20 h-20 bg-gradient-to-br from-coral-400/20 to-coral-400/20 rounded-full flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform backdrop-blur-sm border border-coral-300/30">
                <Target className="w-10 h-10 text-coral-400" />
              </div>
      ...
      <section className="px-6 py-20 relative bg-gradient-to-br from-coral-900/35 via-black/20 to-coral-900/35 backdrop-blur-sm border-b border-coral-400/5">
        {/* Accent - grid pattern */}
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h3 className="text-2xl font-light text-transparent bg-clip-text bg-gradient-to-r from-coral-400 to-coral-400 mb-12">
      ...
      <section className="px-6 py-20 relative bg-gradient-to-br from-coral-900/25 via-black/20 to-coral-900/25 backdrop-blur-sm">
        {/* Accent - radiating circles */}
        <div className="absolute inset-0 flex items-center justify-center opacity-10">
          <div className="w-96 h-96 border border-coral-300/30 rounded-full animate-pulse"></div>
          <div className="absolute w-80 h-80 border border-coral-300/20 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
          <div className="absolute w-64 h-64 border border-coral-300/10 rounded-full animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>
        
        <div className="absolute inset-0 bg-gradient-to-r from-coral-500/5 via-white/4 to-coral-500/5"></div>
        <div className="max-w-5xl mx-auto text-center relative z-10">
          {/* Header with Icon */}
          <div className="mb-12">
            <div className="w-20 h-20 bg-gradient-to-r from-coral-400 to-coral-400 rounded-full flex items-center justify-center mb-8 mx-auto border border-coral-300/30 shadow-2xl">
              <Heart className="w-10 h-10 text-white" />
            </div>
            <h2 className="text-4xl lg:text-5xl font-thin text-white mb-8 leading-tight">
              For People Who Actually Want to
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-coral-400 to-coral-400"> Get Better at Love</span>
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <Card className="p-8 border-0 shadow-xl bg-coral-500/10 backdrop-blur-lg rounded-3xl border border-coral-400/20 hover:shadow-2xl transition-all duration-500 transform hover:scale-105 hover:-translate-y-3">
              <div className="w-16 h-16 bg-gradient-to-r from-coral-400/20 to-coral-400/20 rounded-full flex items-center justify-center mb-6 mx-auto border border-coral-300/30">
          ...
          <div className="mb-12">
            ...
            <Link to="/dashboard">
              <Button className="bg-gradient-to-r from-coral-400 to-coral-500 hover:from-coral-300 hover:to-coral-400 text-white px-12 py-8 text-xl rounded-full shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-105 border-0 mb-6 font-light">
                Create Your Profile
                <ArrowRight className="w-6 h-6 ml-3" />
              </Button>
            </Link>
          ...
          <div className="bg-gradient-to-r from-coral-500/10 to-coral-500/10 backdrop-blur-lg p-8 rounded-3xl border border-coral-300/20">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-8 h-8 bg-gradient-to-r from-coral-400/30 to-coral-400/30 rounded-full flex items-center justify-center border border-coral-300/30">
      ...
      {showFloatingButton && (
        <div className="fixed bottom-8 right-8 z-50 animate-fade-in">
          <Link to="/dashboard">
            <Button className="bg-gradient-to-r from-coral-400 to-coral-500 hover:from-coral-300 hover:to-coral-400 text-white px-6 py-4 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:scale-105 backdrop-blur-sm border border-coral-300/20">
              Try It Now

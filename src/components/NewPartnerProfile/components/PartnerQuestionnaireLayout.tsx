...
const PartnerQuestionnaireLayout = ({
  ...
  return <MobileProfileBoundary>
    <div className={`${isModal ? 'w-full h-full' : 'fixed inset-0 bg-transparent z-50 flex items-center justify-center p-0 pb-6 sm:p-3'}`}>
      <div className={`${isModal ? 'w-full h-full flex flex-col' : 'w-full max-w-5xl h-[calc(100dvh-3rem)] max-h-[90dvh] sm:max-h-[58dvh] flex flex-col'} ${

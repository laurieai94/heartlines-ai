...
const PartnerSectionNavigation = ({ 
  ...
  return (
    <div className="flex md:grid md:grid-cols-3 gap-2 overflow-x-auto scrollbar-none pb-1">
      {[1, 2, 3].map((section) => {
        ...
        return (
          <button
            ...
            className={`group min-h-11 py-2 px-3 md:py-1.5 md:px-2.5 rounded-lg transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-0.5 text-left relative overflow-hidden flex-shrink-0 min-w-[140px] md:min-w-0 ${
              isActive 

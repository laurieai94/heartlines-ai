// Partner Profile Question Options

export const PARTNER_PRONOUNS_OPTIONS = [
  "She/her",
  "He/him", 
  "They/them",
  "Other",
...
export const PARTNER_ORIENTATION_OPTIONS = [
  "Straight",
  "Gay",
  "Lesbian", 
  "Bi",
...
export const PARTNER_LOVE_LANGUAGES_OPTIONS = [
  "One-on-one time with no distractions",
  "Physical touch and cuddles",
  "Hyping each other up with words",
  "Doing little things that make life easier",
  "Thoughtful gifts that show you \"get\" them",
  "Deep convos about life at 2am",
...
export const PARTNER_CONFLICT_STYLE_OPTIONS = [
  "Want to talk it out right now",
  "Need space to cool off first",
  "Try to understand where you're coming from",
  "Just want to fix it fast and move on",
  "Get overwhelmed and need reassurance",
...
export const PARTNER_FAMILY_DYNAMIC_OPTIONS = [
...
export const PARTNER_ATTACHMENT_STYLE_OPTIONS = [

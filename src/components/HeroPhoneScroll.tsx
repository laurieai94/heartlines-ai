              ...
              {visibleMessages.map((message) => (
                <div key={message.id} className={`flex gap-2 items-end ${message.type === 'user' ? 'justify-end' : 'justify-start'}`}>
                   ...
                   <FlameIconHalo intensity="subtle" size="sm" animated={false}>
                     <Avatar className="w-6 h-6 md:w-[19px] md:h-[19px] lg:w-[19px] lg:h-[19px] flex-shrink-0">
                       <AvatarImage 
                         src={BRAND.coach.avatarSrc} 
                         alt={BRAND.coach.name} 
                         loading="lazy" 
                   ...
                   {message.type === 'user' && (
                     <Avatar className="w-6 h-6 md:w-[19px] md:h-[19px] lg:w-[19px] lg:h-[19px] flex-shrink-0 ring-2 ring-coral-400/40">
                       <AvatarImage 
                         src={getUserAvatar()} 

    ...
    <div className="space-y-4 max-w-4xl mx-auto">
      ...
      <Card className="p-4 bg-white/5 backdrop-blur-sm border border-white/10 shadow-lg">
        <div className="text-center space-y-4">
          ...
          <p className="text-base text-pink-200/80 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="space-y-3 max-w-2xl mx-auto">
            ...
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-green-300 rounded-full mt-2 flex-shrink-0" />
              <span className="text-pink-200/80 text-sm">We never sell or share your personal information</span>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-2 h-2 bg-green-300 rounded-full mt-2 flex-shrink-0" />
          ...
          <Collapsible open={isPrivacyExpanded} onOpenChange={setIsPrivacyExpanded}>
            <CollapsibleTrigger asChild>
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 transition-transform ${isPrivacyExpanded ? 'rotate-180' : ''}`} />
              </Button>
            </CollapsibleTrigger>
            
            <CollapsibleContent className="space-y-4 mt-4">
              <div className="text-left space-y-3 max-w-3xl mx-auto">
                <h4 className="text-base font-semibold text-white">What this means in detail:</h4>
                <div className="space-y-2">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-green-300 rounded-full mt-2 flex-shrink-0" />

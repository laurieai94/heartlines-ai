...
const ProfileCard = ({
  ...
  return (
    <Card 
      ref={cardRef}
      data-profile-card
      className={`group p-4 md:p-6 lg:p-8 bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-md border border-white/50 shadow-2xl hover:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] 
        ...
        ring-1 ring-white/30 hover:ring-2 hover:ring-white/50 hover:backdrop-blur-lg

    ...
    <div className={`${isMobile ? 'px-2' : 'md:max-w-3xl lg:max-w-4xl md:mx-auto md:px-6'}`}>
      ...
      <div className="flex-shrink-0">
        <div className={`relative w-[40px] h-[40px] md:w-[44px] md:h-[44px] ${isMobile && !isFirstInGroup ? 'invisible' : ''}`}>
          ...
          <div className={`absolute inset-0 rounded-full blur-md ${isMobile ? 'opacity-60' : 'opacity-50'} drop-shadow-lg ${
            isUser 
              ? isMobile 
      ...
      <div
        className={`
          ...
          ${isUser
            ? isMobile
              ? 'bg-gradient-to-br from-coral-500/90 to-orange-500/80 text-white rounded-br-lg border-2 border-coral-400/50 shadow-lg shadow-coral-400/20'
            ...
            : isMobile
              ? 'bg-gradient-to-br from-pink-600/85 via-burgundy-600/75 to-burgundy-700/70 text-white rounded-bl-lg border-2 border-pink-400/40 shadow-lg shadow-pink-400/15'

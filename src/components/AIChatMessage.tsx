      ...
      <div
        className={`
          ...
          ${isUser
            ...
            : isMobile
              ? 'bg-burgundy-800 md:bg-gradient-to-br md:from-pink-600/85 md:via-burgundy-600/75 md:to-burgundy-700/70 text-white border-2 border-pink-400/40 shadow-md shadow-black/20 rounded-bl-sm'
              : 'bg-burgundy-800 md:bg-gradient-to-br md:from-burgundy-700/45 md:via-burgundy-700/40 md:to-pink-900/35 backdrop-blur-xl text-white rounded-bl-lg border-2 border-pink-400/50 ring-2 ring-pink-400/25 md:shadow-[0_8px_32px_rgba(0,0,0,0.6),0_4px_16px_rgba(236,72,153,0.25),inset_0_1px_0_rgba(255,255,255,0.08)]'
          }

      ...
      <div className={`flex flex-col ${
        ...
        <div
          className={`
            ...
            ${isUser
              ? 'md:bg-burgundy-700/40 md:backdrop-blur-xl text-white rounded-br-md md:rounded-br-lg border border-coral-300/30 md:border-2 md:border-coral-300/60 md:ring-2 md:ring-coral-400/30 shadow-[0_8px_32px_rgba(0,0,0,0.6),0_4px_16px_rgba(251,146,60,0.2),inset_0_1px_0_rgba(255,255,255,0.1)]'
              : 'md:bg-gradient-to-br md:from-burgundy-700/45 md:via-burgundy-700/40 md:to-pink-900/35 md:backdrop-blur-xl text-white rounded-bl-md md:rounded-bl-lg border border-pink-400/30 md:border-2 md:border-pink-400/50 md:ring-2 md:ring-pink-400/25 shadow-[0_8px_32px_rgba(0,0,0,0.6),0_4px_16px_rgba(236,72,153,0.25),inset_0_1px_0_rgba(255,255,255,0.08)]'
            }
          `}
        >

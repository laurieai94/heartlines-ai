      ...
      <div className={`flex flex-col ${
        ...
        <div
          className={`
            ...
            ${isUser
              ? 'bg-burgundy-700/40 backdrop-blur-xl text-white rounded-br-md md:rounded-br-lg border-2 border-coral-300/60 ring-2 ring-coral-400/30 shadow-[0_8px_32px_rgba(0,0,0,0.6),0_4px_16px_rgba(251,146,60,0.2),inset_0_1px_0_rgba(255,255,255,0.1)]'
              : 'bg-gradient-to-br from-burgundy-700/45 via-burgundy-700/40 to-pink-900/35 backdrop-blur-xl text-white rounded-bl-md md:rounded-bl-lg border-2 border-pink-400/50 ring-2 ring-pink-400/25 shadow-[0_8px_32px_rgba(0,0,0,0.6),0_4px_16px_rgba(236,72,153,0.25),inset_0_1px_0_rgba(255,255,255,0.08)]'
            }
          `}
        >

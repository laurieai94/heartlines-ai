...
const QuestionnaireSection4 = ({ profileData, updateField, handleMultiSelect, isReady }: QuestionnaireSection4Props) => {
  ...
  return (
    <div className="space-y-8">
      {/* Family Dynamics */}
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/15 p-8 space-y-6">
        <div className="space-y-3">
          ...
          <p className="text-orange-300 font-medium mb-6">Select all that feel relevant (optional)</p>
        </div>
        ...
        <div className="space-y-4">
          {familyDynamicsOptions.slice(0, showAllFamilyOptions ? familyDynamicsOptions.length : 6).map((dynamic) => (
            <button
              ...
              className={`w-full p-6 rounded-xl text-left transition-all duration-200 hover:scale-[1.01] text-lg ${
          ...
          {familyDynamicsOptions.length > 6 && (
            <button
              ...
              className="w-full p-4 rounded-xl bg-white/5 border border-white/10 text-white/70 hover:bg-white/10 transition-all flex items-center justify-center gap-2"
            >
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/15 p-8 space-y-6">
        <div className="space-y-3">
          ...
          <p className="text-orange-300 font-medium mb-6">Select all that apply (optional)</p>
        </div>
      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/15 p-8 space-y-6">
        <div className="space-y-3">
          ...
          <p className="text-orange-300 font-medium mb-6">Select all that resonate (optional)</p>
        </div>

  ...
  switch (section) {
    ...
    case 2: {
      ...
      if (profileData.relationshipStatus) {
        ...
        const hasRelationship = ['Talking to someone', 'Talking stage', 'In a relationship', 'Engaged', 'Married'].includes(profileData.relationshipStatus);
...
export const getCompletedCount = (section: number, profileData: any) => {
  switch (section) {
    ...
    case 2: {
      ...
      const hasRelationship = profileData.relationshipStatus && ['Talking to someone', 'Talking stage', 'In a relationship', 'Engaged', 'Married'].includes(profileData.relationshipStatus);

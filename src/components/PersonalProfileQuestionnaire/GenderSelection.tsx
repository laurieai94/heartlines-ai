      ...
      <div className="grid grid-cols-3 gap-2">
        {genderOptions.map((gender) => (
          <button
            ...
            className={`p-3 rounded-lg text-sm font-medium transition-all text-left hover:scale-105 ${
      ...
      {selectedGenders.includes('Prefer to self-describe') && (
        <div className="mt-3">
          ...
          <Textarea
            ...
            className="questionnaire-button-secondary border-0 text-white placeholder:text-gray-300 text-sm p-3 min-h-[60px] resize-none"
            rows={2}
          />
        </div>
      )}

...
const QuestionnaireContainer = ({
  ...
  return (
    <div className={`${isModal ? 'h-full' : 'fixed inset-0 questionnaire-bg backdrop-blur-sm z-50 flex items-center justify-center'}`}>
      <div className={`${isModal ? 'h-full' : 'w-full max-w-2xl max-h-[80vh]'} flex flex-col ${isModal ? '' : 'border border-white/15 rounded-2xl bg-white/10 backdrop-blur-xl shadow-2xl'}`}>

  ...
  return (
    <Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
      <CollapsibleTrigger className="w-full">
        <div className="bg-white/20 hover:bg-white/30 sm:bg-white/10 sm:hover:bg-white/20 rounded-xl border border-white/30 hover:border-white/40 sm:border-white/20 sm:hover:border-white/30 ring-1 ring-white/10 sm:ring-white/5 focus-visible:ring-2 focus-visible:ring-white/30 p-2.5 transition-all duration-200 shadow-sm">

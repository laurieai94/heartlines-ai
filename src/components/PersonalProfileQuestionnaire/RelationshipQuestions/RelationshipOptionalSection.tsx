  ...
  return (
    <Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
      <CollapsibleTrigger className="w-full">
        <div className="bg-white/40 hover:bg-white/50 sm:bg-white/10 sm:hover:bg-white/20 rounded-xl border border-white/50 hover:border-white/60 sm:border-white/20 sm:hover:border-white/30 ring-1 ring-white/20 sm:ring-white/5 focus-visible:ring-2 focus-visible:ring-white/30 p-2.5 transition-all duration-200 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <Label className="hidden sm:block text-sm font-medium text-white/80">

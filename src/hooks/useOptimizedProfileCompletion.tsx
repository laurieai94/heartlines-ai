...
export const useOptimizedProfileCompletion = () => {
  const { profileData: personalData, isReady: personalReady } = useOptimizedPersonalProfileData();
  const { profileData: partnerData, isReady: partnerReady } = useOptimizedPartnerProfileData();
